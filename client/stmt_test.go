...
func TestStmt_DropTable(t *testing.T) {
	str := `drop table if exists go_proxy_test_stmt`
...
func TestStmt_CreateTable(t *testing.T) {
	str := `CREATE TABLE IF NOT EXISTS go_proxy_test_stmt (
...
func TestStmt_Delete(t *testing.T) {
	str := `delete from go_proxy_test_stmt`
...
func TestStmt_Insert(t *testing.T) {
	str := `insert into go_proxy_test_stmt (id, str, f, e, u, i) values (?, ?, ?, ?, ?, ?)`
...
func TestStmt_Select(t *testing.T) {
	str := `select str, f, e from go_proxy_test_stmt where id = ?`
...
func TestStmt_NULL(t *testing.T) {
	str := `insert into go_proxy_test_stmt (id, str, f, e) values (?, ?, ?, ?)`
	...
	str = `select * from go_proxy_test_stmt where id = ?`
	s, err = c.Prepare(str)
...
func TestStmt_Unsigned(t *testing.T) {
	str := `insert into go_proxy_test_stmt (id, u) values (?, ?)`
	...
	str = `select u from go_proxy_test_stmt where id = ?`
...
func TestStmt_Signed(t *testing.T) {
	str := `insert into go_proxy_test_stmt (id, i) values (?, ?)`
...
func TestStmt_Trans(t *testing.T) {
	...
	if _, err := c.Execute(`insert into go_proxy_test_stmt (id, str) values (1002, "abc")`); err != nil {
		t.Fatal(err)
	}
	...
	str := `select str from go_proxy_test_stmt where id = ?`
