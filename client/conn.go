...
func (c *Conn) Execute(command string) (*Result, error) {
...
func (c *Conn) readUntilEOF(predict int) (ret [][]byte, err error) {
...
func (c *Conn) isErrPacket(data []byte) bool {
...
func (c *Conn) SetAutocommit(f bool) (err error) {
