...
func TestShard_DeleteHashTable(t *testing.T) {
	s := `drop table if exists go_proxy_test_shard_hash`
...
func TestShard_CreateHashTable(t *testing.T) {
	s := `CREATE TABLE IF NOT EXISTS go_proxy_test_shard_hash (
...
func TestShard_Hash(t *testing.T) {
	table := "go_proxy_test_shard_hash"
...
func TestShard_DeleteRangeTable(t *testing.T) {
	s := `drop table if exists go_proxy_test_shard_range`
...
func TestShard_CreateRangeTable(t *testing.T) {
	s := `CREATE TABLE IF NOT EXISTS go_proxy_test_shard_range (
          id BIGINT(64) UNSIGNED  NOT NULL,
          str VARCHAR(256),
          PRIMARY KEY (id)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8`
...
func TestShard_Range(t *testing.T) {
	table := "go_proxy_test_shard_range"
	testShard_Insert(t, table, "node2", 0, "a")
