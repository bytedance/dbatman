...
import (
	...
	"fmt"
	"io"
	"micode.be.xiaomi.com/wangjing1/go-mysql-proxy/testfiles"
	"os"
	"runtime"
	"strings"
	"testing"
...
func BenchmarkParseSelectJoin(b *testing.B) {
	sql := "select a.a, a.b, a.cccc, b.a, b.b, b.c from a join b on a.a = b.a where b.b > 1062 or a.b < 19423 group by b.c order by a.cccc"
	for i := 0; i < b.N; i++ {
		_, err := Parse(sql)
		if err != nil {
			b.Fatal(err)
